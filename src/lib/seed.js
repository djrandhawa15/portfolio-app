...
Replace the entire contents of `src/lib/seed.js` with this. The structure is clean — copy-paste the whole thing to avoid any partial-edit issues.    description: "CINE HUB is an innovative movie database project designed to provide users with a comprehensive and immersive movie experience. CINE HUB offers a vast collection of information about movies, TV shows, actors, and more.\n\nCreated by: Priya, Simran, Dilraj, and Mudarres.\n\nThis product uses the TMDb API but is not endorsed or certified by TMDb.",
    image: "/images/projects/cinehub/logo.svg",
    link: "https://cinehub-h3qq.onrender.com/",
    keywords: ["JavaScript", "CSS", "HTML", "React", "Vite", "TMDb API"],
    logo: "/images/projects/cinehub/logo.svg",
